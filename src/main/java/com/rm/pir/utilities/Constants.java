...
public class Constants {
    public static final String SERVER_URL = "http://partners.normal-library.org/";
//    public static final String SERVER_URL = "http://localhost/";
    
    public static final String ADMIN_NPL_EMAIL = "partnersinreading@normalpl.org";
    public static final String ADMIN_NPL_EMAIL_PASS = "Normal1757";
